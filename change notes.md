...
################################################################################
Thursday January 16th, 2025 14:59:10 CST
## version
V2.1.0

## modify
1. Only support JT16
2. Supports timeout detection for point clouds
3. Supports retrying to open the serial port for point cloud reception on timeout.
